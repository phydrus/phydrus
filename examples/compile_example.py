...
4. See compilation examples
5. Ensure executable is available
6. Use the compiled executable in a model
...
print(
    f"Available compilers: {', '.join(compiler_info['compilers']) if compiler_info['compilers'] else 'None'}"
)
...
print("# exe_path = ps.compile_hydrus(target_exe='./hydrus_orig/hydrus')")
print("#")
