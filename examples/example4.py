...
# Time info
times = ml.add_time_info(tmax=100, print_times=True, dt=0.001, dtmin=0.000001)
# Water flow info
...
m.loc[1:7] = [
    [0.065, 0.42, 0.016, 1.94, 95.040, 0.5],
...
profile = ps.create_profile(
    bot=[-7, -19, -24, -28, -50, -75, -100], dx=1, h=-100, mat=m.index
)
...
times1 = ml.add_time_info(tmax=360, print_times=True, dt=0.001, dtmin=0.000001)
