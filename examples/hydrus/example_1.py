...
ml.basic_information["lShort"] = False

ml.time_information["tInit"] = 0 #Initial time of the simulation [T]
ml.time_information["tMax"] = 1  #Final time of the simulation [T]
ml.time_information["MPL"] = 12
ml.time_information["dt"] = 0.001
ml.time_information["dtMin"] = 0.00001
ml.time_information["dtMax"] = 5
ml.time_information["nPrintSteps"] = 1
ml.time_information["tPrintInterval"] = 1
...
printtimes = np.linspace(start = ml.time_information["tInit"],\
                                   stop = ml.time_information["tMax"], \
                                   num = ml.time_information["MPL"]+1)[1:]
